...
namespace CIFEA
{
    public partial class Square : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                lblFrequency.Text = "* Please select a value";
            ...
            if (eStart && eStop && current && eStep && amplitude && frequency && serialPort)
            {
                ...
                float frequencyval = int.Parse(Convert.ToString(cmbFrequency.Text));
                ...
                totalData = methodTypeBytes.Concat(eStartvalBytes).Concat(eStopvalBytes).Concat(currentvalBytes).Concat(currentTypevalBytes).Concat(eStepvalBytes).Concat(amplitudevalBytes).Concat(frequencyvalBytes).ToArray();
